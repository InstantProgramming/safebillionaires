...
"""Verify that starting safebillionaire with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start safebillionaire with -h for help text")
        ...
        self.log.info("Start safebillionaire with -version for version information")
        ...
        self.log.info("Start safebillionaired with -fakearg to make sure it does not start")
