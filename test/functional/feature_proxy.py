...
"""Test safebillionaired with different proxy configuration.

Test plan:
- Start safebillionaired's with different proxy configurations
- Use addnode to initiate connections
- Verify that proxies are connected to, and the right connection command is given
- Proxy configurations to test on safebillionaired side:
