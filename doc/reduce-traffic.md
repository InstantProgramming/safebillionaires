...
By default, Safebillionaire Core allows up to 125 connections to different peers, 8 of
...
limits are tiny. Keep in mind that safebillionaire's trustless model works best if you are
