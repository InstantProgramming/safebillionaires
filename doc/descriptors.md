# Support for Output Descriptors in Safebillionaire Core

Since Safebillionaire Core v0.17, there is support for Output Descriptors. This is a
...
on Safebillionaire's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Safebillionaire Core wallets, a convenience function `combo` is
