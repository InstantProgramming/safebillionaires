Safebillionaire Core version *0.15.1* is now available from:

  <https://download.safebillionaire.org/safebillionaire-0.15.1/>
...
A number of changes to the way Safebillionaire Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 millionaires per kB (0.00001 SBLN). This is to prepare for dropping the minimum transaction fee to 0.1 millionaires per kB (0.0001 SBLN) in the next release.
