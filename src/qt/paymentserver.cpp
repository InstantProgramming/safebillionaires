...
const QString BITCOIN_IPC_PREFIX("safebillionaire:");
#ifdef ENABLE_BIP70
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/safebillionaire-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/safebillionaire-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/safebillionaire-paymentrequest";
#endif
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(nullptr, tr("Payment request error"),
                tr("Cannot start safebillionaire: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("safebillionaire://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'safebillionaire://' is not a valid URI. Use 'safebillionaire:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Safebillionaire address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
