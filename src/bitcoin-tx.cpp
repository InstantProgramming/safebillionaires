...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " safebillionaire-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  safebillionaire-tx [options] <hex-tx> [commands]  Update hex-encoded safebillionaire transaction\n" +
            "or:     safebillionaire-tx [options] -create [commands]   Create hex-encoded safebillionaire transaction\n" +
            "\n";
